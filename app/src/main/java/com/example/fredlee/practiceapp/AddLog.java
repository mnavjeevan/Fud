...
/**
 * Created by Jason Lee on 11/15/2014.
 */
public class AddLog extends Activity{
    ...
    public void addListenerOnButtonClick(){
        ...
        submit.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                returnIntent.putExtra("address", mCurrentPhotoPath);
                returnIntent.putExtra("date", timeStamp);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button picBtn = (Button) findViewById(R.id.bPicture);
